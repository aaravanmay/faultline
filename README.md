...
```
Verified against real installed LangGraph, LangChain, LlamaIndex, pydantic-ai and crewAI (`tests/test_langgraph_adapter.py`), including a deterministic end-to-end catch on a real `create_react_agent` (`faultline/examples/langgraph_catch.py`).
